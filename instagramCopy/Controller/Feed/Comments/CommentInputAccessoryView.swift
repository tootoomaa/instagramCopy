...
//    tv.placeholder = "   Enter comment... "
  ...
  override init(frame: CGRect) {
    ...
    commentTextView.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, right: postButton.leftAnchor, paddingTop: 8, paddingLeft: 8, paddingBottom: 0, paddingRight: 8, width: 0, height: 0)
